  ...
  <footer class="bg-slate-900 text-slate-400">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <!-- Quick links -->
        <div>
          <h3 class="font-semibold text-white mb-4 text-sm uppercase tracking-wider">Navigasi</h3>
          <ul class="space-y-2">
        ...
        <!-- Social + copyright -->
        <div>
          <h3 class="font-semibold text-white mb-4 text-sm uppercase tracking-wider">Ikuti Kami</h3>
