...
import { dummyCourseList, dummyPartners } from '~/data/dummy'
...
const featuredCourses = computed(() => dummyCourseList.slice(0, 3))
const featuredPartners = computed(() => dummyPartners.slice(0, 4))
</script>
  ...
  <div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <PartnerCard v-for="partner in featuredPartners" :key="partner.id" :partner="partner" />
      </div>
    </section>
